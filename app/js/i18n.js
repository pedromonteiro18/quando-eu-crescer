...
const S = {
  ...
  /* ── what Clara SAYS ────────────────────────────────────────────────────
     These are not labels, they are recordings. Each string here is the exact
     text of a clip in app/audio/ui (English) or app/audio/ui-pt (Portuguese),
     and build/build-audio.mjs renders both lists from the same source of truth.
     Change a word here and the clip stops resolving, so don't — re-render.

     Everything in this block is an INSTRUCTION. Nothing being taught is ever
     spoken from here: a vocabulary word, a phrase, a dialogue line and a
     passage all come out of the topic's own folder, in English, always. */
